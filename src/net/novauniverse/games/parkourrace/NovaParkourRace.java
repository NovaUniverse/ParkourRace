...
import net.novauniverse.games.parkourrace.game.modules.pads.InstantDeathPad;
...
public class NovaParkourRace extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		MapModuleManager.addMapModule("parkourrace.pads.instantdeath", InstantDeathPad.class);
